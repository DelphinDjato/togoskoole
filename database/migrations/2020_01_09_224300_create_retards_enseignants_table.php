...
class CreateRetardsEnseignantsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('retards_enseignants', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('retards_enseignants');
    }
}
